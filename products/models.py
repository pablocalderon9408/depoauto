...
class Category(models.Model):
    ...
    image_file = models.ImageField(upload_to='categories/', blank=True, null=True, max_length=255)
...
class Product(models.Model):
    ...
    image_url = models.URLField(max_length=500, blank=True)
    image_file = models.ImageField(upload_to='products/', blank=True, null=True, max_length=255)
...
class VariantImage(models.Model):
    ...
    image_file = models.ImageField(upload_to='products/variants/', blank=True, null=True, max_length=255)
...
class SiteConfig(models.Model):
    ...
    hero_image_1_file = models.ImageField(upload_to='site/hero/', blank=True, null=True, max_length=255)
    ...
    hero_image_2_file = models.ImageField(upload_to='site/hero/', blank=True, null=True, max_length=255)
    ...
    hero_image_3_file = models.ImageField(upload_to='site/hero/', blank=True, null=True, max_length=255)
...
class HeroSlide(models.Model):
    ...
    image_url = models.URLField(max_length=500, blank=True, null=True)
    image_file = models.ImageField(upload_to='site/hero/', blank=True, null=True, max_length=255)
